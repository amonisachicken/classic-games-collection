...
pub const ZH: Ui = Ui {
    ...
    breakout_help_ready: "←→/HL 移动    空格 发球    ESC/Q 菜单",
    breakout_help: "←→/HL 移动    ESC/Q 菜单",
    tetris_title: "俄罗斯方块",
    tetris_sub: "TETRIS",
    lines_fmt: "行数 {}",
    level_fmt: "等级 {}",
...
pub const EN: Ui = Ui {
    ...
    breakout_help_ready: "←→/HL move    Space launch    ESC/Q menu",
    breakout_help: "←→/HL move    ESC/Q menu",
    tetris_title: "TETRIS",
    tetris_sub: "",
    lines_fmt: "Lines {}",
    level_fmt: "Level {}",
